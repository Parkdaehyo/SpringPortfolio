...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header text-white" style="background-color: #3232FF;"> 게시글 등록</div>
      <div class="card-body">

        <form role="form" method="post"> <!--  action이 생략되있고 Post방식이면 자기자신한테 보낸다. -->
        
          <div class="form-group" hidden="hidden"> <!--  hidden 태그: 실제 태그구조는 남아있지만  사용자에게는 보이지 않음-->
            <label>작성자</label>
